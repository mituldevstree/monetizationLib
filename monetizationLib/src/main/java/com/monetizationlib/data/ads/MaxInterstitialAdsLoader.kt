...
@Keep
class MaxInterstitialAdsLoader : IInterstitialAdsLoader, MaxAdListener {
    ...
    companion object {
        ...
        private var instance: MaxInterstitialAdsLoader? = null
        fun getInstance(): MaxInterstitialAdsLoader? {
            if (instance == null) {
                synchronized(MaxInterstitialAdsLoader::class.java) {
                    if (instance == null) {
                        instance = MaxInterstitialAdsLoader()
                    }
                }
            }
            return instance
    ...
    override fun initialize(context: Context) {
        Monetization.logWtfIfNeeded("MaxInterstitialAdsLoader initialize method is called successfully")
        interstitialAd = MaxInterstitialAd(
            Monetization.adConfig?.interstitialAdUnit,
    ...
    override fun showAd(): GivvyAd {
        Monetization.logWtfIfNeeded("MaxInterstitialAdsLoader showAd method is called successfully with interstitialAd = $interstitialAd interstitialAd?.isReady == ${interstitialAd?.isReady == true}")
    ...
    override fun loadAd() {
        ...
        Monetization.logWtfIfNeeded("MaxInterstitialAdsLoader loadAd method is called successfully with interstitialAd == $interstitialAd")
    }
    ...
    override fun onAdLoaded(ad: MaxAd) {
        ...
        Monetization.logWtfIfNeeded("MaxInterstitialAdsLoader onAdLoaded method is called successfully with interstitialAd == $interstitialAd with adRevenue = $adRevenue and AD = $ad, networkName = $networkName")
    ...
    override fun onAdLoadFailed(adUnitId: String, error: MaxError) {
        Monetization.logWtfIfNeeded("MaxInterstitialAdsLoader onAdLoadFailed method is called successfully with error == $error")
    ...
    override fun onAdClicked(ad: MaxAd) {
        if (MaxRevenueTracker.currentImpressions.size > 0) {
            ...
            if (ad != null) {
                ...
                MaxRevenueTracker.isInAd = false
                Monetization.logWtfIfNeeded("sendImpressionData MaxInterstitialAdsLoader onAdClicked")
    ...
    override fun onAdDisplayFailed(ad: MaxAd, error: MaxError) {
        Monetization.logWtfIfNeeded("MaxInterstitialAdsLoader onAdDisplayFailed method is called successfully with error == $error and ad = $ad")
    ...
    override fun onAdLoadedButNotReady() {
        Monetization.logWtfIfNeeded("MaxInterstitialAdsLoader onAdLoadedButNotReady called with interstitialAd?.isReady = ${interstitialAd?.isReady} && interstitialAd = $interstitialAd")
        if(interstitialAd != null && interstitialAd?.isReady != true) {
            Monetization.logWtfIfNeeded("MaxInterstitialAdsLoader onAdLoadedButNotReady")
            interstitialAd?.destroy()
            interstitialAd = null
            adRevenue = 0.0
            networkName = "unknown"
